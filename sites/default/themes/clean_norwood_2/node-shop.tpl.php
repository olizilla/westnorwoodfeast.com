...
<div <?php print drupal_attributes($attr) ?>>
  ...
  <?php //if (!$page): ?>
    <h3 class='node-title'>
      <span class='node-type-title'><?php print l(t('Shop'), 'map/shop') ?> : </span><?php print ucwords($node->title); ?>
    </h3>
  <?php //endif ?>
  ...
  <!--<div class="share-links">
  	<a href="http://www.facebook.com/share.php?u=http://westnorwood.spacemakers.org.uk/<?php print $curr_uri = check_plain(request_uri()); ?>">Share on Facebook</a>
  </div>-->
